...
f = subprocess.Popen(['tail','-F',"/home/jmotacek/hyperledger-pi-composer/logs/peer0org2log.txt"],\
        ...
        if p.poll(1):
            ...
            try:
                ...
                if not 'Message GossipMessage: tag:EMPTY alive_msg' in line:
                    ...
                    if 'Anchor peers for org Org2MSP are anchor_peers:<host:"peer0.org2.ptunstad.no"' in line:
                        GPIO.output(27,GPIO.HIGH)
